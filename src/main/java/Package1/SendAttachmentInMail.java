   ...
   public void sendFileToMail(String agentName, String agentEmail,String managerEmail) 
   {
     ...
     props.put("mail.smtp.host", host);
      ...
      try {
        ...
        // String filename = "C:\\Selenium\\Eclipse Workspace\\PaginatedReports_Maven\\src\\main\\resources\\DownloadedFiles\\"+"Daily Marketing Report by Agent - "+agentName+".xlsx";
         String filename = "DownloadedFiles\\"+"Daily Marketing Report by Agent - "+agentName+".xlsx";
